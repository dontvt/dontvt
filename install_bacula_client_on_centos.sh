...
BACULA_SERVICE_DIR_NAME=mobileshop-backup-dir
BACULA_SERVICE_DIR_PASSWD="zcDd8/p/Dc7569v+hNi/QNWn6lvqNlrhCGLRge+EtgFO"
BACULA_SERVICE_MON_NAME=mobileshop-backup-mon
BACULA_SERVICE_MON_PASSWD="hzK/hemS/Q2TSweM0ipuXP7HN5Cz7ydHwYojbKkMC79u"
BACULA_FILE_DAEMON_NAME=mobileshop-backup-fd
BACULA_DIR_ADDRESS=192.168.35.119
BACULA_DIR_NAME=backup.appota
